...
#define USB_PULLUP_DISABLE                  GPIO_PIN_SET
#define USB_PULLUP_ENABLE                   GPIO_PIN_RESET
#endif
...
void HAL_PCDEx_SetConnectionState(PCD_HandleTypeDef *hpcd, uint8_t state)
{
  if (state != 0)
  {
    ...
    HAL_GPIO_WritePin(USB_DISCONNECT_PORT, USB_DISCONNECT_PIN, USB_PULLUP_ENABLE);
...
#error Device not specified.
  ...
  else
  {
    ...
    HAL_GPIO_WritePin(USB_DISCONNECT_PORT, USB_DISCONNECT_PIN, USB_PULLUP_DISABLE);
#elif defined(STM32L151xB)
    /*  DP Pull-Down is Internal */
